          ...
          <div className="relative overflow-hidden rounded-[2rem] bg-[#006cb1] p-8 text-white md:p-14">
            ...
            <div className="relative grid items-start gap-8 lg:grid-cols-[1.15fr_0.85fr] lg:items-center lg:gap-10">
              <div>
                ...
                <h2 className="mt-6 font-display text-[clamp(1.9rem,4.6vw,3.3rem)] font-extrabold leading-[1.04] tracking-tight">
                  Stuck on something?
                  <br />
                ...
                <div className="mt-8 flex flex-wrap items-center gap-4">
                  <a href={`mailto:${address.email}?subject=Support%20request`} className="w-full sm:w-auto">
                    <Button variant="white" className="w-full rounded-full px-7 py-3.5 text-[0.92rem] sm:w-auto">
                      Email us
                    </Button>
                  </a>
                  <a href="https://www.google.com/maps/search/?api=1&query=Hamburger+Strasse+73+38122+Braunschweig" target="_blank" rel="noreferrer" className="w-full sm:w-auto">
                    <Button variant="ghost" className="w-full rounded-full px-7 py-3.5 text-[0.92rem] sm:w-auto">
                      Get directions
                    </Button>
                  </a>
                </div>
